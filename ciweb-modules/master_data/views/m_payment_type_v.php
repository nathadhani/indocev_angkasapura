                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group row">
                                <label for="payment_type_name" class="control-label col-lg-4">Peayment Type Name</label>
                                <div class="col-lg-8">
                                    <input type="text" id="payment_type_name" name="payment_type_name" placeholder="Tipe Pembayaran..." data-validation="required" class="form-control">
