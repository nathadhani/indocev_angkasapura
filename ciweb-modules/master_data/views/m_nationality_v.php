                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group row">
                                <label for="menu" class="control-label col-lg-4">Nationality Code</label>
                                <div class="col-lg-8">
                                    <input type="text" id="nationality_code" name="nationality_code" placeholder="Kewarganegaraan..." data-validation="required" class="form-control">
                                    <!-- <span class="help-block">Tipe Nasabah</span> -->
                                </div>
                            </div><!-- /.form-group -->                            
                            <div class="form-group row">
                                <label for="menu" class="control-label col-lg-4">Description</label>
                                <div class="col-lg-8">
                                    <input type="text" id="nationality_desc" name="nationality_desc" placeholder="Keterangan..." data-validation="required" class="form-control">
                                    <!-- <span class="help-block">Tipe Nasabah</span> -->
                                </div>
                            </div><!-- /.form-group -->                            
                        </div>
