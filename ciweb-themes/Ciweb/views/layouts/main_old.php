...
<div class="page-content">
    ...
    <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
        ...
        <?php 
            if(!in_array($usergroup_id, array('1','2','4','6'))) {            
        ?>
            <li class="xn-icon-button">
        ...
        ?>
            ...
            <li class="xn-icon-button">
                <a href="api/api_transaction_input" title="API - Trx Record" data-toggle="tooltip" data-placement="bottom"><span class="fa fa-th-list"></span></a>
                <?php
                    if($company_id != null){
