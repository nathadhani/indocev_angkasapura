                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" id="airport_code" name="airport_code" placeholder="Kode Bandara..." data-validation="required" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" id="airport_desc" name="airport_desc" placeholder="Keterangan..." data-validation="required" class="form-control">
                                    <!-- <span class="help-block">Tipe Nasabah</span> -->
                                </div>
                            </div><!-- /.form-group -->                            
                        </div>
