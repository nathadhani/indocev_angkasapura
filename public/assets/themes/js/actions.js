...
function panel_fullscreen(panel){    
    ...
    if(panel.hasClass("panel-fullscreened")){
        ...
        panel.find("#chart3").height($(window).height() - hplus);
        panel.find("#chart4").height($(window).height() - hplus);
...
function panel_refresh(panel,action,callback){        
    if(!panel.hasClass("panel-refreshing")){
        panel.append('<div class="panel-refresh-layer"><img src="assets/themes/img/loaders/default.gif"/></div>');        
