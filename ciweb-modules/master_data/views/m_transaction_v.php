                ...
                <div class="panel-body">                                                                        
                    <div class="row">
                        <div class="col-lg-6">                            
                            ...
                            <div class="form-group row">
                                <label for="menu" class="control-label col-lg-4">Keterangan</label>
                                <div class="col-lg-8">
                                    <input type="text" id="description" name="description" placeholder="Keterangan..." data-validation="required" class="form-control">                                    
                                </div>
                            </div><!-- /.form-group -->
                        </div>
                        <div class="col-lg-6">
