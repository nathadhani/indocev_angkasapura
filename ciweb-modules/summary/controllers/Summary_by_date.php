...
class Summary_by_date extends Bks_Controller {

    function __construct() {
        $config = array('modules' => 'summary', 'jsfiles' => array('summary_by_date'));
    ...
    function index() {
        ...
        $data['auth'] = $this->auth;
        $this->template->build('summary/summary_by_date_v', $data);
    }
