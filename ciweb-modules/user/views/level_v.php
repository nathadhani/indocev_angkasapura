                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group row">
                                <label for="usergroupname" class="control-label col-lg-4">Nama User Level</label>
                                <div class="col-lg-8">
                                    <input type="text" autofocus="" id="userlevelname" name="userlevelname" placeholder="Nama User Level..." data-validation="required" class="form-control">
                                </div>
                            </div><!-- /.form-group -->
                        </div>
                        <div class="col-lg-6">
